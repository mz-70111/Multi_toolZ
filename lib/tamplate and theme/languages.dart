class Lang {
  ...
  static Map lang = {
    ...
    'addtask': ['تكليف بمهمة', 'add task'],
    'addouttask': ['طلب مهمة خارجية', 'external task'],
    ...
    'logpagetitle': ['سجل العمليات', 'Logs record'],
    'search': ['بحث', 'search'],
    ...
    'addmember': ['إضافة موظف', 'add member'],
    'save': ['حفظ', 'save'],
    'cancle': ['اغلاق', 'cancle'],
    'remove': ['حذف', 'remove'],
    'supervisor': ['مشرف', 'supervisor'],
    'employee': ['موظف', 'employee'],
    'notifi': ['الإشعارات', 'Notification'],
    'add': ['إضافة', 'Add'],
    'duplicate': ['الاسم محجوز مسبقا', 'this name is already existed'],
  };
}
